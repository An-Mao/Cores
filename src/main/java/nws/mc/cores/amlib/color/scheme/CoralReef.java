...
public class CoralReef extends _ColorScheme {
    ...
    protected void pushColor() {
        _ColorScheme.Color c = new _ColorScheme.Color(0xFFFF6F61, 0xFFFF8A80, 0xFFFF5252);
        addColor("border", c);
        addColor("element_border", c);
        c = new _ColorScheme.Color(0xFFFFE0E0, 0xFFFFCDD2, 0xFFFF8A80);
        addColor("background", c);
        addColor("element_background", c);
        c = new _ColorScheme.Color(0xFF212121, 0xFF424242, 0xFF616161);
        addColor("text", c);
