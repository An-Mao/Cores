...
public abstract class ImageWidgetCore<T extends ImageWidgetCore<T>> extends RenderWidgetCore<T> {
    ...
    public void drawImage(GuiGraphics guiGraphics, DT_XYWHUV xywhuv){
        guiGraphics.blit(resourceLocation -> RenderType.gui(),texture,xywhuv.getX(),xywhuv.getY(),xywhuv.getUOffset(),xywhuv.getVOffset(),xywhuv.getWidth(),xywhuv.getHeight(),xywhuv.getWidth(),xywhuv.getHeight());
    }
