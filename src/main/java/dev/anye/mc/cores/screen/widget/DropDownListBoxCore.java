...
public abstract class DropDownListBoxCore  extends AbstractWidget {
    ...
    public void drawStr(GuiGraphicsExtractor guiGraphics,Component component,int x,int y,int color){
        guiGraphics.text(font,component,x,y,color,textShadow);
    }
    @Override
    protected abstract void extractWidgetRenderState(GuiGraphicsExtractor pGuiGraphics, int pMouseX, int pMouseY, float pPartialTick);
