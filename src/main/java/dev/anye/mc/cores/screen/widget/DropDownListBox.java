...
public class DropDownListBox extends DropDownListBoxCore {
    public static final Component NullString = Component.literal("---NULL---");
    ...
    public List<ClientTooltipComponent> getDataTooltip(int index){
        ...
        return List.of(ClientTooltipComponent.create(NullString.getVisualOrderText())) ;
    }
    ...
    @Override
    public void extractWidgetRenderState(@NotNull GuiGraphicsExtractor guiGraphics, int pMouseX, int pMouseY, float pPartialTick) {
