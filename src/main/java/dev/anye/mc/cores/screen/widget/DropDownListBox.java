...
public class DropDownListBox extends DropDownListBoxCore {
    ...
    @Override
    public boolean mouseScrolled(double pMouseX, double pMouseY,double sy) {
        if (showList) {
        ...
        return super.mouseScrolled(pMouseX, pMouseY,sy);

    }
    @Override
    protected void updateWidgetNarration(NarrationElementOutput pNarrationElementOutput) {
        pNarrationElementOutput.add(NarratedElementType.TITLE,Component.empty());
    }
}