...
public class GuiGraphicsX extends RenderCore{
    public static void Sector(GuiGraphics guiGraphics,int x,int y,int outerRadius, double startArc, double endArc, int color) {
        guiGraphics.getRenderState().submitGuiElement(new SectorRenderState(
                guiGraphics.pose(),
                x,y,
                outerRadius,
                startArc,
    ...
    public static void SectorX(GuiGraphics guiGraphics,int x,int y, int innerRadiusX, int innerRadiusY, int outerRadiusX, int outerRadiusY, double startArc, double endArc, int color) {
        guiGraphics.getRenderState().submitGuiElement(new SectorXRenderState(
                guiGraphics.pose(),
                x,y,
                innerRadiusX,
                innerRadiusY,
    ...
    public static void RoundedRect(GuiGraphics guiGraphics, int x, int y, int width, int height, int radius, int borderColor, int fillColor) {
        ...
        guiGraphics.getRenderState().submitGuiElement(new RectRenderState(
                RenderPipelines.GUI,
        ...
        poseStack.pushMatrix();
        guiGraphics.getRenderState().submitGuiElement(new BorderRenderState(
                RenderPipelines.GUI,
                TextureSetup.noTexture(),
