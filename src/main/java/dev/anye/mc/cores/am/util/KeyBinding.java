...
public class KeyBinding {
	...
	public static final KeyMapping OPEN_MENU = new KeyMapping(KEY_MENU, KeyConflictContext.IN_GAME, InputConstants.Type.KEYBOARD, InputConstants.KEY_HOME, new KeyMapping.Category(KEY_CATEGORY_RES));
}
