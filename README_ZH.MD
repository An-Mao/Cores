...
按Home键打开配置界面
![Home界面](https://github.com/An-Mao/Cores/blob/main/image/home_screen.png)
选择配色方案
![配色方案选择](https://github.com/An-Mao/Cores/blob/main/image/home_screen_select_color_scheme.png)
保存后查看效果
